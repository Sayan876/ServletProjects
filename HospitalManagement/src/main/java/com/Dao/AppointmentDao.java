...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			...
			String sql = "insert into appointment(user_id, fullname, gender, age, appointdate, gmail, phone, diseases, doctorid, address, status) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public List<Appointment> getAlllAppointment() {
		List<Appointment> list = new ArrayList<Appointment>();
		Appointment ap = null;
